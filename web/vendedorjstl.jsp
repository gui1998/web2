...
<html>
    ...
    <body>
        ...
        <div class="container">
            <form method="POST" action="vendedorjstl">
                <input type="hidden" name="id" value="${vendedor.id}"/>
                <div class="form-group">
                    <label id="labelNome" for="nome">Nome:</label>
                    <input class="form-control" type="text" id="nome" name="nome" required value="${vendedor.nome}" />
                </div>
                ...
                <tbody>
                    ...
                    <c:forEach var="c" items="${lista}">
                        <tr>
                            ...
                            <td>${c.cpf}</td>
                            <td>
                                <a href="vendedorjstl?editar=${c.id}">
                                    <button class="btn btn-primary">Editar</button>
                                </a>
                                <a href="vendedorjstl?excluir=${c.id}">
